...
lib.getValidStringOrFalse = function(str, minLength) {
...
lib.getValidObjectOrDefault = function(data, defaultData) {
    return typeof(data) == 'object' ? data : defaultData;
};

lib.getObjStringOrDefault = function(data) {
    var str = lib.getValidStringOrFalse(data, 0);
    if (str) {
        return str;
    }
...
lib.hash = function(str){
    if (lib.isValidStringMinLen(str, 0)) {
