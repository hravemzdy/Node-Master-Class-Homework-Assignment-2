...
service._createChargeAndNotifyToEmail = function(userEmail,orderInvoice,callback){
  // Call charge API
  _stripe.chargeCustomerMock(orderInvoice.orderNumber, orderInvoice.totalCharge, 'usd', function(errCharge){
    if (!errCharge){
...
service._createEmailAndNotifyToEmail = function(orderInvoice,callback){
  ...
  {
    // Call mailgun API
    _mailgun.notifyCustomerByEmailMock(emailConfirmation, function(errEmail){
      if (!errEmail){
