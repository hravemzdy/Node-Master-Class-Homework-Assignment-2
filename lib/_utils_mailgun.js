...
lib.notifyCustomerByEmail = function(confirmation, callback){
  var email = helpers.getValidStringOrFalse(confirmation.emailTo, 0);
  var name = helpers.getValidStringOrFalse(confirmation.nameTo, 0);
  var msg = helpers.getValidStringMinMaxLenOrFalse(confirmation.msg, 1, 1600);
  var token = helpers.getValidStringOrFalse(libKey.token_priv, 0);
  var orderNumber = helpers.getValidStringOrFalse(confirmation.invoice.orderNumber, 0);
