...
handlers.post = function(data, callback){
    ...
    var password = helpers.getValidStringOrFalse(data.payload.password, 0);
    var fullname = helpers.getValidStringOrFalse(data.payload.fullname, 0);
    var address = helpers.getValidStringOrFalse(data.payload.address, 0);
