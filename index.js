 ...
 * Note: Use the stripe sandbox for your testing. Follow this link and click on the "tokens" tab 
 * to see the fake tokens you can use server-side to confirm the integration is working: 
